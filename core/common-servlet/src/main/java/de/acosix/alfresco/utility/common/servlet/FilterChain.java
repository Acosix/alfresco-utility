...
/**
 * An abstraction of the two Servlet API variants' FilterChain API.
 *
 * @author Axel Faust
 */
public interface FilterChain
{
     ...
     */
    void doFilter(ServletRequest request, ServletResponse response) throws IOException, WrappedServletException;
}
